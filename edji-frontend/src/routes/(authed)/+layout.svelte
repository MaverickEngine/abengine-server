        ...
        <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
           <ul class="space-y-2 font-medium">
              ...
              <li aria-current={$page.url.pathname === '/explorer' ? 'page' : undefined}>
                 <a href="/explorer" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white group">
              ...
              <li aria-current={$page.url.pathname === '/users' ? 'page' : undefined}>
                 <a href="/users" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white group">
