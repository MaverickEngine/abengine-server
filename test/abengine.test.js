...
const random_campaign_uid = randomString(10, 20);
let experiments = [];

for(let i = 0; i < experiment_count; i++) {
    experiments.push({
        uid: `Experiment ${randomString(10, 20)}`,
...
describe('Tests', () => {
	...
	describe("create_campaign", () => {
		it("it should create a campaign", (done) => {
			chai.request(api_server)
				...
				.send({ uid: `${random_campaign_uid}`, experiments, running: true })
				.end((err, res) => {
                    console.log(res.body);
					res.should.have.status(200);
					res.body.success.should.equal(true);
                    res.body.campaign.should.have.property('_id');
                    res.body.campaign.should.have.property('uid');
    ...
    describe("serve_experiment_1", () => {
        const iterations = iteration_count;
            ...
            it("it should serve an experiment", (done) => {
                chai.request(abengine_server)
                    ...
                    .end((err, res) => {
                        ...
                        res.body.experiment.should.have.property('uid');
    ...
    describe("test_cookies", () => {
        ...
        for (let x = 0; x < iteration_count / 10; x++) {
